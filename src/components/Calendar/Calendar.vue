<template>
  <div class="scrollable-container">
    <div class="scrollable-content ion-padding ion-text-capitalize" ref="contentRef">
      <div v-for="(day, index) in next30Days" :key="index" class="day-box ion-text-center" @click="selectDay(day)"
...
const emits = defineEmits(['returnDaySelected']);
...
const selectDay = (index: any) => {
  ...
  emits('returnDaySelected', selectedDay.value);
};
