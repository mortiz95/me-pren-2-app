        ...
        <ion-grid class="ion-no-padding ion-no-margin">
          ...
          <ion-row>
            <ion-col size="12" class="ion-text-center button-container">
              <ion-button fill="clear" :id="`open-action-sheet-${index}`" expand="full"
                class="btn-unsubscribe-clear"><u>Darse de baja</u>
              </ion-button>
              <ion-action-sheet :trigger="`open-action-sheet-${index}`" header="Esta seguro que desea darse de baja?"
