    ...
    <ion-tabs>
      ...
      <ion-tab-bar>
        ...
        <ion-tab-button tab="tab2" href="/tabs/tab2">
          ...
          <ion-label>Crear Juego</ion-label>
        </ion-tab-button>

        <ion-tab-button tab="tab3" href="/tabs/tab3">
          <ion-icon aria-hidden="true" :icon="pinOutline" />
...
import { footballOutline, addCircleOutline, pinOutline, personCircleOutline } from 'ionicons/icons';
</script>
