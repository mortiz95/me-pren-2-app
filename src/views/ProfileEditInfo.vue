                    ...
                    <ion-row class="ion-align-items-center">
                        <ion-col size="auto">
                            <ion-icon :icon="chevronBackOutline" class="ion-align-item-start"
                                @click="backToProfile()"></ion-icon>
                        </ion-col>
                        <ion-col>
                            <h2 class="ion-no-margin ion-margin-start">Editar informacion</h2>
                        </ion-col>
                    </ion-row>
                </ion-grid>
            </ion-toolbar>
                                        ...
                                        <ion-col>
                                            <ion-list :inset="false" lines="inset" class="ion-no-margin ion-no-padding">
                                                <ion-item>
                                                    ...
                                                    <ion-input v-model="userInfo.country" readonly color="light"
                                                        label="Pais" label-placement="floating"
                                                ...
                                                <ion-item>
                                                    ...
                                                    <ion-select :value="userInfo.city" @ionChange="handleCity($event)"
                                                        ...
                                                        <ion-select-option value="san Lorenzo">San
                                                            Lorenzo</ion-select-option>
                                                ...
                                                <ion-item>
                                                    ...
                                                    <ion-select :value="userInfo.sport" label="Deporte" color="light"
                                                        ...
                                                        <ion-select-option selected
                                                            value="futbol">Futbol</ion-select-option>
                                                        <!--                                              <ion-select-option value="basket">Basket</ion-select-option>
                                                <ion-select-option value="paddle">Paddle</ion-select-option>
                                                <ion-select-option value="tenis">Tenis</ion-select-option>
                                                <ion-select-option value="hockey">Hockey</ion-select-option> -->
                                                ...
                                                <ion-item>
                                                    ...
                                                    <ion-select :value="userInfo.gender" @ionChange="handleGender($event)"
                                                        ...
                                                        :toggle-icon="chevronDownCircleOutline" :expanded-icon="remove">
                                                        <ion-select-option selected
                                                            value="male">Masculino</ion-select-option>
                                            ...
                                            <ion-list :inset="false" lines="inset" class="ion-no-margin ion-no-padding">
                                                ...
                                                <ion-item>
                                                    ...
                                                    <ion-select :value="userInfo.position" multiple
                                                        ...
                                                        label-placement="floating" color="light"
                                                        ...
                                                        <ion-select-option
                                                            value="midfielder">Mediocampista</ion-select-option>
                                                        <ion-select-option selected
                                                ...
                                                <ion-item>
                                                    ...
                                                    <ion-select :value="userInfo.motivation"
                                                        :toggle-icon="chevronDownCircleOutline" multiple
                                                        :expanded-icon="remove" @ionChange="handleMotivation($event)"
                                                        label="Motivacion:" label-placement="floating" color="light"
                                                        class="ion-select-skills" :interface-options="options">
                                                ...
                                                <ion-item>
                                                    ...
                                                    <ion-select :value="userInfo.level"
                                                        :toggle-icon="chevronDownCircleOutline" class="ion-select-skills"
                                                        :expanded-icon="remove" @ionChange="handleLevel($event)"
                                                        label="Nivel:" label-placement="floating" color="light"
                                                        :interface-options="options">
...
const userInfo = ref({
    ...
    level: userStore.myUserInfo.level,
    freeCreateSearch: userStore.myUserInfo.freeCreateSearch,
    freeJoinSearch: userStore.myUserInfo.freeJoinSearch
});
